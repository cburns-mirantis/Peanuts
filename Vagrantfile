Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo -n "Runbook Builder Address: http://";ip -f inet addr show eth1 | grep -Po 'inet \K[\d.]+'
  SHELL
end
